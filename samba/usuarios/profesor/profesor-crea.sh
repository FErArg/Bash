...
function archivousuario () {
    ...
    echo "---------------------------------------------------------------------------------------------------------" >> $destino/$fecha-${usuario[1]}-asignaturas.txt
    echo "${usuario[1]};${usuario[2]};${usuario[3]};${usuario[4]};${usuario[5]};${usuario[6]};${usuario[7]};" >> $destino/$fecha-${usuario[1]}-asignaturas.txt
    echo "Asignaturas ${asignatura[*]}" >> $destino/usuarios-asignaturas.txt
    echo "---------------------------------------------------------------------------------------------------------" >> $destino/$fecha-${usuario[1]}-asignaturas.txt
            }
...
echo "Crea usuario Profesor"
usuario[1]="profesor" # Tipo de Usuario
unset leer
echo ""
read -p "Ingrese Nombre Completo: " leer
usuario[2]=$leer
unset leer	
...
if grep "^${usuario[3]}:" /etc/passwd
   then
    echo ""
    echo "--------------------------------------------------------------------"
    echo "                             			SerInformaticos.es"
